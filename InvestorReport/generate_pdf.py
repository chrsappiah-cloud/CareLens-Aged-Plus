...
pdf.add_page_with_image(
    ...
    "promo_04_subscription_model.png",
    [
        "## 4-Tier Subscription with Apple Pay",
        "- Free ($0/mo): Basic health overview, 1 Care Circle, 7-day history",
        "- Starter ($9.99/mo): Unlimited Care Circle, real-time alerts, 30-day history",
        "- Professional ($29.99/mo): Unlimited clients, custom alerts, 90-day history, priority support",
        "- Enterprise ($99.99/mo): Multi-location, advanced analytics, API access, dedicated manager",
        "",
        "## 5-Year Revenue Projections",
        "2025: $1.2M ARR (5K users) | 2026: $2.8M (12K) | 2027: $6.5M (28K)",
        "2028: $12.5M (55K) | 2029: $21.5M (95K) | 2030: $35M+ (150K+)",
        "",
        "Seamless Apple Pay integration for frictionless subscription conversion.",
    ]
)
...
pdf.add_page_with_image(
    ...
    [
        ...
        "- Admin Panel: Role-based access, compliance, billing management",
...
pdf.add_page_with_image(
    ...
    [
        ...
        "Full user management, subscription oversight, organisation configuration, compliance reporting, and real-time system health monitoring.",
        "",
...
pdf.add_page_with_image(
    ...
    [
        ...
        "- Payments: StoreKit 2, Apple Pay seamless subscriptions",
...
pdf.add_page_with_image(
    ...
    [
        ...
        "- Revenue-ready 4-tier SaaS model with Apple Pay",
